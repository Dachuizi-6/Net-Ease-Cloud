  ...
  <div>
    ...
    <div class="singerContainer">
      ...
      <div class="singerLeft">
        <div class="singerLeftList">
          <div class="singerLeftItem-top">
            <h2>推荐</h2>
            <ul>
              <a href="###" class="active">
                <li>推荐歌手</li>
...
export default {
  ...
  async mounted (area) {
    ...
    console.log(this.$store.dispatch('getSingerList'))
    console.log(this.$store.state.singer.singerList)
  }
}
</script>
